...
Revision ID: d1d2830a3a72
Revises: 
Create Date: 2018-08-24 20:36:20.347425
...
def upgrade():
    ...
    op.create_index(op.f('ix_set_name'), 'set', ['name'], unique=False)
    ...
    op.create_index(op.f('ix_song_number'), 'song', ['number'], unique=True)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('sheet')
    op.drop_index(op.f('ix_song_number'), table_name='song')
